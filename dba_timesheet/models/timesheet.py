            ...
            if weekday == str(notification.reminder_day):
                for user in users:
                    mail_values = {
                        ...
                        'body_html':notification.reminder_message,
                ...
                for user in not_submit_ts_users:
                    ...
                    if len(related_employee):
                        ...
                        mail_values = {
                            ...
                            'recipient_ids':user.partner_id,
                            'reply_to':admin.partner_id.email,
                            'body_html':notification.notify_message
...
class TimesheetNotificationConfig(models.Model):
    ...
    reminder_message = fields.Html(string="Reminder Message",required=True)
    notify_message = fields.Html(string="Notification Message",required=True)
